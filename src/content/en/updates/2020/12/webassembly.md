...
{# wf_featured_image: /web/updates/images/2020/12/webassembly/featured.png #}
...
![](/web/updates/images/2020/12/webassembly/image5.png)

A year ago, Chrome [announced initial
support](https://developers.google.com/web/updates/2019/12/webassembly)
...
![](/web/updates/images/2020/12/webassembly/image11.png)
...
![](/web/updates/images/2020/12/webassembly/image7.png)
...
![](/web/updates/images/2020/12/webassembly/image9.png)
...
fractal shape with some random colours:
...
At this point our `palette` has been filled with some random colours,
...
unoptimised version to enable debugging. This version is a lot slower,
...
panel](https://developers.google.com/web/tools/chrome-devtools/evaluate-performance/reference)
...
### Debugging optimised builds {: #release-builds }

Like with any other languages, debugging works best if optimisations are
disabled. Optimisations might inline functions one into another, reorder
...
debug an optimised build, then most of the optimisations will work as
...
disable it when compiling with any `-O` level optimisations, e.g.:
...
When combined with optimisations like described above, this feature can
be even used to ship almost-optimised production builds of your
...
- Working on improvements to the [profiling](https://developers.google.com/web/tools/chrome-devtools/evaluate-performance/reference) for WebAssembly apps.
- Adding support for [code coverage](https://developers.google.com/web/tools/chrome-devtools/coverage) to make it easier to find unused code.
- Improving support for expressions in console evaluation.
- Adding support for more languages.
- …and more!

Meanwhile, please try the current beta on your own code, help us out by
reporting any found issues to
[https://bugs.chromium.org/p/chromium/issues/entry?template=DevTools+issue](https://bugs.chromium.org/p/chromium/issues/entry?template=DevTools+issue)
